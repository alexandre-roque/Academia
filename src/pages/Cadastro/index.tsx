        ...
        <div className="w-full max-w-md m-auto bg-slate-300 rounded-lg border border-primaryBorder shadow-default py-10 px-16">
            ...
            <form onSubmit={handleFormSubmit}>
                ...
                <div className="relative w-full flex flex-col">
                    ...
                    <input className="rounded-md peer pl-12 w-full p-2 border outline-none text-sm transition duration-150 ease-in-out mb-4" type="text" name="card_number" placeholder="0000 0000 0000" />
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="relative flex-1 flex flex-col">
                        ...
                        <input className="rounded-md peer pl-12 w-full p-2 border outline-none text-sm transition duration-150 ease-in-out mb-4" type="text" name="expire_date" placeholder="MM/YY" />
                        <svg xmlns="http://www.w3.org/2000/svg" className="absolute bottom-3 left-0 -mb-0.5 transform translate-x-1/2 -translate-y-1/2 text-black peer-placeholder-shown:text-gray-300 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <div className="relative flex-1 flex flex-col">
                        ...
                        <input className="rounded-md peer pl-12 w-full p-2 border outline-none text-sm transition duration-150 ease-in-out mb-4" type="text" name="card_cvc" placeholder="&bull;&bull;&bull;" />
                        <svg xmlns="http://www.w3.org/2000/svg" className="absolute bottom-3 left-0 -mb-0.5 transform translate-x-1/2 -translate-y-1/2 text-black peer-placeholder-shown:text-gray-300 h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
